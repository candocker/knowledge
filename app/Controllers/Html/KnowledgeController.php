...
class KnowledgeController extends AbstractController
{
    ...
    public function entrance($navCode = '', $subNavCode = '')
    {
        ...
        if (in_array($navCode, ['wghistory', 'figure', 'zghistory', 'culture', 'region'])) {
    ...
    public function wikiDetail($type, $code)
    {
        ...
        $detailDatas = $this->getSubjectServiceObj()->getPointDetail($type, $code, $isMobile);
        if (isset($detailDatas['tdkData'])) {
