...
return [
    ...
    'topNavs' => [
        ...
        'bookstore' => [
            'name' => '书架',
            'subDatas' => [
                ['code' => 'classical', 'name' => '中国古籍 ( 36本 )', 'url' => '/bookstore-classical'],
                ['code' => 'luxun', 'name' => '鲁迅著作', 'url' => '/bookstore-luxun'],
                [
                    'code' => 'shwhanyixueshu',
                    'name' => '汉译学术名著',
                    'subDatas' => [
                        ['code' => 'philosophy', 'name' => '哲学 ( 285本 )', 'url' => '/bookstore-philosophy'],
                        ['code' => 'history', 'name' => '历史·地理 ( 172本 )', 'url' => '/bookstore-history'],
                        ['code' => 'politics', 'name' => '政治·法律·社会 ( 202本 )', 'url' => '/bookstore-politics'],
                        ['code' => 'economics', 'name' => '经济 ( 166本 )', 'url' => '/bookstore-economics'],
                        ['code' => 'language', 'name' => '语言·文艺理论 ( 25本 )', 'url' => '/bookstore-language'],
                        ['code' => 'otheracademic', 'name' => '学术补编 ( 99本 )', 'url' => '/bookstore-otheracademic'],
                    ],
                ],
                ['code' => 'other', 'name' => '其他著作 ( 12本 )', 'url' => '/bookstore-other'],
